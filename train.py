...
# process.load_data_split(FLAGS.dataset,FLAGS.train_size,shuffle=True) # 'cora', 'citeseer', 'pubmed'


# adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask = \
# process.load_data_sparse_graph(FLAGS.dataset,FLAGS.train_size,shuffle=True) # 'cora_ml', 'amazon_c', 'amazon_p'

adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask = \
process.load_data_sparse_graph_ms(FLAGS.dataset,FLAGS.train_size,shuffle=True)# 'ms_academic_cs', 'ms_academic_phy'
